...
<template>
    <nav class="fixed bottom-0 w-full bg-white shadow-inner pb-5">
        <div v-if="user" class="flex justify-around items-center h-[60px] pr-4 pl-4 gap-5" >
            <div class="flex gap-[2px] items-center flex-col p-[7px] rounded-xl" :style="{ background: active === 'tickets' ? '#00000010' : 'transparent' }">
                <img src="/assets/icons/qr.svg" alt="Ticket icon" class="w-[20px]" />
                <h2 class="text-[12px] font-bold">Entradas</h2>
            </div>
            <div
                @click="router.get(route('index'))"
                class="flex gap-[2px] items-center flex-col p-[7px] rounded-xl" :style="{ background: active === 'index' ? '#00000010' : 'transparent' }">
                <img src="/assets/icons/fire.svg" alt="Discount icon" class="w-[20px]" />
                <h2 class="text-[12px] font-bold">Ofertas</h2>
            </div>
            <div class="flex gap-[2px] items-center flex-col p-[7px] rounded-xl" :style="{ background: active === 'search' ? '#00000010' : 'transparent' }">
        ...
        <div v-else class="flex justify-around items-center h-[60px] pr-4 pl-4 gap-5" >
            <div class="flex gap-[2px] items-center flex-col p-[7px] rounded-xl" :style="{ background: active === 'index' ? '#00000010' : 'transparent' }">
